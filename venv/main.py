...
file.close
encodeListKnown, studentIds = encodeListKnownWithIds  # extrax file encode
# print(studentIds)
...
while True:
    ...
    if counter != 0:
        ...
        studentInfo['total_attendance'] = int(
        ...
        cv2.putText(imgBackground, str(studentInfo['years']), (1025, 625),
                    cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
        cv2.putText(imgBackground, str(studentInfo['strating_year']), (1125, 625),
                    cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
        (w, h), _ = cv2.getTextSize(
            studentInfo['name'], cv2.FONT_HERSHEY_COMPLEX, 1, 1)
        offset = (414-w)//2
        cv2.putText(imgBackground, str(studentInfo['name']), (850, 445),
